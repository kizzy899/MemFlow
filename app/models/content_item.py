...
class ContentItem(Base):
    ...
    media_fetch_status: Mapped[str] = mapped_column(String(20), default="skipped")
    media_provider: Mapped[str] = mapped_column(String(30), default="")
    ocr_status: Mapped[str] = mapped_column(String(20), default="skipped")
